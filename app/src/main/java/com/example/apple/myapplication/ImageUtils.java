...
public class ImageUtils {
    ...
    public static ArrayList getCoordinates(InputStream jsonStream, String landmark) {
        ...
        try {
            ...
            JSONArray Coordinates = object.getJSONArray(landmark);

            for (int i = 0; i < 2; i++) {
                coor.add(Coordinates.getDouble(i));
            }
    ...
    public static JSONObject getPosition (InputStream jsonStream){
        ...
        try{
            ...
            position = new JSONObject(jsonString);
